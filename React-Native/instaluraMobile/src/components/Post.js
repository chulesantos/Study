        ...
        if(!foto.likeada) {
          ...
          exibeLegenda(foto) {
            ...
            return (
              ...
              <Text style={styles.tituloComentario}>chulecabral</Text>
            ...
            exibeLikes(likers) {
              ...
              render() {
                ...
                return (
                  ...
                  <Image source={require('../../resources/img/users/chulecabral.jpg')} style={styles.fotoPerfil}/>
                  <Text>chulecabral</Text>
                  </View>
